...
Issues in [`MARKETProtocol/dApp`](https://github.com/MARKETProtocol/dApp/issues) are the primary means by which bug reports and
...
Fork the project [on GitHub](https://github.com/MARKETProtocol/dApp) and clone your
fork locally.

```shell
git clone git@github.com:username/dApp.git
cd dApp
git remote add upstream https://github.com/MARKETProtocol/dApp.git
git fetch upstream
```
...
4. If your PR fixed an issue, Use the `Fixes:` prefix and the full issue URL.
  For other references use `Refs:`.
    ...
    _Examples:_
    * `Fixes: https://github.com/MARKETProtocol/dApp/issues/1`
    * `Refs: https://github.com/MARKETProtocol/dApp/issues/1`
...
Ensure your PR follows the [template](https://github.com/MARKETProtocol/dApp/blob/develop/.github/PULL_REQUEST_TEMPLATE.md), so that it's
